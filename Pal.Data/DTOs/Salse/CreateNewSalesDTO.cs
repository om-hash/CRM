...
{
    public class CreateNewSalesDTO
    {
        ...
        [StringLength(500)]
        public string SalesLogo { get; set; }
        public IFormFile SalesLogoFile { get; set; } //
        ...
        public List<CreateNewSalesTranslateDTO> SalesTranslates { get; set; }
